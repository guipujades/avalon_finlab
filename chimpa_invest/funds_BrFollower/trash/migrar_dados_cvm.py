...
# Diretórios
SOURCE_DIR = Path("C:/Users/guilh/Documents/GitHub/sherpa/database/INF_DIARIO")
TARGET_DIR = Path("C:/Users/guilh/Documents/GitHub/database/funds_cvm/INF_DIARIO")

def migrar_dados_fundos():
    ...
    for origem, destino in tqdm(arquivos_copiar, desc="Copiando arquivos"):
